...
public:		// constants
	...
	static constexpr int
		...
		FONT_LIGHT_GRAY_STCM_R = 0xa8,
		FONT_LIGHT_GRAY_STCM_G = 0xa8,
		FONT_LIGHT_GRAY_STCM_B = 0xa8,
		//FONT_LIGHT_GRAY_STCM_R = 0xa0,
		//FONT_LIGHT_GRAY_STCM_G = 0xa0,
		//FONT_LIGHT_GRAY_STCM_B = 0xa0,
		//--------
		FONT_DARK_GRAY_STCM_R = 0x68,
		FONT_DARK_GRAY_STCM_G = 0x68,
		FONT_DARK_GRAY_STCM_B = 0x68,

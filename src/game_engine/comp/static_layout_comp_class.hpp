...
public:		// constants
	static const std::string
		...
		TILE_WALL_DRAW_DATA_STR,
		TILE_FLOOR_DRAW_DATA_STR,
		TILE_UP_STAIRS_DRAW_DATA_STR,
		TILE_DOWN_STAIRS_DRAW_DATA_STR,

		TILE_DOOR_DRAW_DATA_STR,
		TILE_PIT_DRAW_DATA_STR,
		TILE_WATER_DRAW_DATA_STR,

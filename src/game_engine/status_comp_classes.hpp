...
#ifndef src_game_engine_status_comp_classes_hpp
#define src_game_engine_status_comp_classes_hpp

// src/game_engine/status_comp_classes.hpp
...
#endif		// src_game_engine_status_comp_classes_hpp

...
void Engine::create_save_file_if_needed()
{
	printout("game_engine::Engine::create_save_file_if_needed(): ",
		"testificate\n");

	bool perf_create = false;
		...
		file.is_open())
	{
		...
		{
			printerr("game_engine::Engine::create_save_file_if_needed(): ",
